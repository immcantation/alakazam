...
A small example AIRR-format database, `ExampleDb`, is included in the `alakazam` package. 
...
(`clone="clone_id"`). For each clonal group, only the most common family/gene/allele will
