...
`generalizeDiversity` function with confidence intervals derived via bootstrapping.  
...
curve <- generalizeDiversity(ExampleDb, group="SAMPLE", ci=0.95, nboot=200, 
      generalize="alpha")
```
...
plotAbundanceCurve(curve, colors = sample_colors, legend_title="Sample")
```

## Generate a diversity curve

The function `generalizeDiversity` performs uniform resampling of the input 
...
sample_curve <- generalizeDiversity(ExampleDb, group="SAMPLE",
                             min_q=0, max_q=4, step_q=0.1,
                             ci=0.95, nboot=200, generalize="alpha")
...
isotype_curve <- generalizeDiversity(ExampleDb, group="ISOTYPE",
                             min_q=0, max_q=4, step_q=0.1,
                             ci=0.95, nboot=200, generalize="alpha")
```
...
sample_main <- paste0("Sample diversity (n=", sample_curve$ndepth, ")")
sample_colors <- c("-1h"="seagreen", "+7d"="steelblue")
plotDiversityCurve(sample_curve, colors=sample_colors, main_title=sample_main, 
     legend_title="Sample")

# Plot isotype diversity using default set of Ig isotype colors
isotype_main <- paste0("Isotype diversity (n=", isotype_curve$ndepth, ")")
plotDiversityCurve(isotype_curve, colors=IG_COLORS, main_title=isotype_main, 
