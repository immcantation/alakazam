...
clones <- countClones(ExampleDb, group="SAMPLE", clone="CLONE")
head(clones, 5)
```
...
clones <- countClones(ExampleDb, group=c("SAMPLE", "ISOTYPE"), copy="DUPCOUNT", clone="CLONE")
head(clones, 5)
```
...
curve <- estimateAbundance(ExampleDb, group="SAMPLE", ci=0.95, nboot=200, clone="CLONE")
```
...
isotype_test <- alphaDiversity(ExampleDb, group="ISOTYPE", min_q=0, max_q=2, step_q=1, nboot=200, clone="CLONE")
