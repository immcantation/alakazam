...
--------------------------------------------------------------------------------
The function `resampleDiversity` performs uniform resampling, without replacement
by default, of the input sequences and recalculates the clone size distribution, 
and diversity, with each resampling realization. Diversity (D) is calculated over a
...
the same manner as `resampleDiversity`, but only for a single diversity order. 
