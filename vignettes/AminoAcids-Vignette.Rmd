...
db_props_h <- aminoAcidProperties(db, seq="JUNCTION", nt=TRUE, trim=FALSE, label="CDR3", hydropathy=h)
db_props_h[1:5,15:23]
```
...
db_props_bulk <- aminoAcidProperties(db, seq="JUNCTION", nt=TRUE, trim=FALSE, label="CDR3", bulkiness=x, pH=7.0)
db_props_bulk[1:5,15:23]
```
