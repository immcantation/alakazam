---
title: 'Alakazam: Analysis of amino acid physicochemical chemical properties'
...
```{r, eval=TRUE, warning=FALSE}
db_g <- aminoAcidProperties(db, seq="JUNCTION", property="gravy",
...
db_g_h <- aminoAcidProperties(db, seq="JUNCTION", property="gravy", nt=TRUE, trim=FALSE, label="CDR3", hydropathy=h)
colnames(db_g_h)
db_g_h[1:5,15]
```
...
db_props_bulk <- aminoAcidProperties(db, seq="JUNCTION", property="bulk", nt=TRUE, trim=FALSE, label="CDR3", bulkiness=x, pH=7.0)
